...
public enum ResultCode {
 ...
 SELF_BOOKING_NOT_ALLOWED(2004, "interpreter.self.booking"),
 SELF_REVIEW_NOT_ALLOWED(2005, "interpreter.self.review"),
 ...
 PARKING_VEHICLE_DUPLICATE(4003, "parking.vehicle.duplicate"),
